...
For more info, look at config/environments/development.rb[config/environments/development.rb]

<b>2) Modify Number of Async Workers</b>

Unicorn is being used as the web server to support asynchronous request handling.  The default number
of workers is 3, but this can be modified in config/unicorn.rb[config/unicorn.rb].
